...
Jena to zbiór narzędzi Javy do tworzenia aplikacji semantycznych WWW
opartych na rekomendacjach W3C dla RDF i OWL. Udostępnia: API RDF,
ARP - analizator RDF, RDQL - język zapytań RDF, API OWL oraz oparte na
regułach wnioskowanie dla RDFS i OWL.
